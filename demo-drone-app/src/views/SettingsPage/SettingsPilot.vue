	...
	<v-card style="padding:15px;">
		...
		<v-layout row>
			<v-layout column>
              ...
              type="username"
              v-model="user_info.pilot.faa_registration_number"
              required/>
            <v-text-field
...
export default {
    ...
    async _update_pilot_info() {
      var pilot_info = {
        'faa_registration_number': this.user_info.pilot.faa_registration_number,
        'remote_pilot_certificate_number': this.user_info.remote_pilot_certificate_number,
        'mobile_phone_number': this.user_info.mobile_phone_number
      }
